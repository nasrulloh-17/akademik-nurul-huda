...
<section class="hero">
    <div class="hero-grid">
        <div>
            ...
            <p style="font-size:19px;color:#41615e;max-width:620px">Sistem informasi akademik terpadu.</p>
